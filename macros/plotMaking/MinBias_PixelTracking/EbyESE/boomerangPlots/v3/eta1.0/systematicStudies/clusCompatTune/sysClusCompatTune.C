...
void sysClusCompatTune(){
  ...
  for(int icent = 0; icent < NCENT; icent++){
    ...
    //-- Ratio to default
    if(vn22pct == 0 || vn2Default == 0) vn22pct_RatioToDefault[icent] = -1000.;
    else                                vn22pct_RatioToDefault[icent] = vn22pct / vn2Default;
    if(vn42pct == 0 || vn4Default == 0) vn42pct_RatioToDefault[icent] = -1000.;
    else                                vn42pct_RatioToDefault[icent] = vn42pct/ vn4Default;
    if(vn62pct == 0 || vn6Default == 0) vn62pct_RatioToDefault[icent] = -1000.;
    else                                vn62pct_RatioToDefault[icent] = vn62pct/ vn6Default;
    if(vn82pct == 0 || vn8Default == 0) vn82pct_RatioToDefault[icent] = -1000.;
  ...
  formatGraph(grVn22pct,    "Centrality %", cumuMin,   cumuMax,   Form("v_{%i}{2}", norder_),                    9,         24, "grVn22pct");
  formatGraph(grVn42pct,    "Centrality %", cumuMin,   cumuMax,   Form("v_{%i}{4}", norder_),                    kSpring+4, 24, "grVn42pct");
  formatGraph(grVn62pct,    "Centrality %", cumuMin,   cumuMax,   Form("v_{%i}{6}", norder_),                    6,         24, "grVn62pct");
  formatGraph(grVn82pct,    "Centrality %", cumuMin,   cumuMax,   Form("v_{%i}{8}", norder_),                    kOrange+7, 24, "grVn82pct");
  formatGraph(grVn6Vn42pct, "Centrality %", vn6vn4Min, vn6vn4Max, Form("v_{%i}{6}/v_{%i}{4}", norder_, norder_), 4,         24, "grVn6Vn42pct");
  formatGraph(grVn8Vn42pct, "Centrality %", vn8vn4Min, vn8vn4Max, Form("v_{%i}{8}/v_{%i}{4}", norder_, norder_), kGreen+2,  24, "grVn8Vn42pct");
  formatGraph(grVn8Vn62pct, "Centrality %", vn8vn6Min, vn8vn6Max, Form("v_{%i}{8}/v_{%i}{6}", norder_, norder_), kViolet-1, 24, "grVn8Vn62pct");
  ...
  formatGraph(grVn42pct_RatioToDefault,    "Centrality %", 0.90,   1.10,   Form("v_{%i}{4} Ratio", norder_),                    kSpring+4, 24, "grVn42pct_RatioToDefault");
