...
void ebyeCumuSkew(){
  ...
  grvn8vn6Ratio->SetMinimum(0.95);
  grvn8vn6Ratio->SetMaximum(1.02);
  ...
  cGamma1Exp->SaveAs("plots/skew/cGamma1Exp.pdf");
  ...
  latex.DrawLatex(0.2, 0.27, Form("|#eta| < %.1f", tkEta));
  latex.DrawLatex(0.2, 0.21, Form("%.2f < p_{T} < %.2f GeV/c", pt_min[0], pt_max[NPT-1]));
  cvn6vn4Ratio->SaveAs("plots/skew/cvn6vn4Ratio.pdf");
  ...
  latex.DrawLatex(0.2, 0.27, Form("|#eta| < %.1f", tkEta));
  latex.DrawLatex(0.2, 0.21, Form("%.2f < p_{T} < %.2f GeV/c", pt_min[0], pt_max[NPT-1]));
  cvn8vn4Ratio->SaveAs("plots/skew/cvn8vn4Ratio.pdf");
  ...
  latex.DrawLatex(0.2, 0.27, Form("|#eta| < %.1f", tkEta));
  latex.DrawLatex(0.2, 0.21, Form("%.2f < p_{T} < %.2f GeV/c", pt_min[0], pt_max[NPT-1]));
  cvn8vn6Ratio->SaveAs("plots/skew/cvn8vn6Ratio.pdf");
