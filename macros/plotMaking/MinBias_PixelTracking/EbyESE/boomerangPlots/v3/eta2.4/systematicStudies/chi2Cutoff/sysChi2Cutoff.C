...
void sysChi2Cutoff(){
  ...
  double ratioVn2Min = 0.95;
  double ratioVn2Max = 1.05;
  double ratioVn4Min = 0.95;
  double ratioVn4Max = 1.05;
  double ratioVn6Min = 0.95;
  double ratioVn6Max = 1.05;
  double ratioVn8Min = 0.95;
  double ratioVn8Max = 1.05;

  double ratioGamma1ExpMin = 0.75;
  double ratioGamma1ExpMax = 1.25;
  ...
  TLine * l1 = new TLine(diter[0], 1.0, diter[NITER-1], 1.0);
  l1->SetLineColor(1);
  l1->SetLineWidth(2);
  l1->SetLineStyle(2);
  ...
  for(int icent = 0; icent < NCENT; icent++){
    ...
    ratioChi2_21_gamma1exp[icent]  = fabs( unfoldGamma1Exp_RatioToChi21[icent][3] );
  ...
  grRatioChi2_21_vn2 = new TGraphErrors(NCENT, centBinCenter, ratioChi2_21_vn2, cErr, cErr);
  formatGraph(grRatioChi2_21_vn2, "Centrality %", ratioMin, ratioMax, Form("v_{%i}{2} [#chi^{2}=2]/[#chi^{2}=1]", norder_), 1, 24, "grRatioChi2_21_vn2");
  grRatioChi2_21_vn4 = new TGraphErrors(NCENT, centBinCenter, ratioChi2_21_vn4, cErr, cErr);
  ...
  grRatioChi2_21_vn6 = new TGraphErrors(NCENT, centBinCenter, ratioChi2_21_vn6, cErr, cErr);
  formatGraph(grRatioChi2_21_vn6, "Centrality %", ratioMin, ratioMax, Form("v_{%i}{6} [#chi^{2}=2]/[#chi^{2}=1]", norder_), 6, 28, "grRatioChi2_21_vn6");
  grRatioChi2_21_vn8 = new TGraphErrors(NCENT, centBinCenter, ratioChi2_21_vn8, cErr, cErr);
  ...
  grRatioChi2_21_gamma1exp = new TGraphErrors(NCENT, centBinCenter, ratioChi2_21_gamma1exp, cErr, cErr);
  ...
  grRatioChi2_21_vn6vn4 = new TGraphErrors(NCENT, centBinCenter, ratioChi2_21_vn6vn4, cErr, cErr);
  ...
  grRatioChi2_21_vn8vn4 = new TGraphErrors(NCENT, centBinCenter, ratioChi2_21_vn8vn4, cErr, cErr);
  ...
  grRatioChi2_21_vn8vn6 = new TGraphErrors(NCENT, centBinCenter, ratioChi2_21_vn8vn6, cErr, cErr);
  ...
  for(int icent = 0; icent < NCENT; icent++){
    ...
    for(int i = 0; i < 4; i++){
      ...
      double vn2Pct    = fabs(unfold_Vn2VSChi2Cut[icent][i] - unfold_Vn2VSChi2Cut[icent][0]) / fabs(unfold_Vn2VSChi2Cut[icent][0]);
      double vn4Pct    = fabs(unfold_Vn4VSChi2Cut[icent][i] - unfold_Vn4VSChi2Cut[icent][0]) / fabs(unfold_Vn4VSChi2Cut[icent][0]);
      double vn6Pct    = fabs(unfold_Vn6VSChi2Cut[icent][i] - unfold_Vn6VSChi2Cut[icent][0]) / fabs(unfold_Vn6VSChi2Cut[icent][0]);
      double vn8Pct    = fabs(unfold_Vn8VSChi2Cut[icent][i] - unfold_Vn8VSChi2Cut[icent][0]) / fabs(unfold_Vn8VSChi2Cut[icent][0]);
      double g1expPct  = fabs(unfold_Gamma1ExpVSChi2Cut[icent][i] - unfold_Gamma1ExpVSChi2Cut[icent][0]) / fabs(unfold_Gamma1ExpVSChi2Cut[icent][0]);
      double vn6vn4Pct = fabs(unfold_Vn6Vn4VSChi2Cut[icent][i] - unfold_Vn6Vn4VSChi2Cut[icent][0]) / fabs(unfold_Vn6Vn4VSChi2Cut[icent][0]);
      double vn8vn4Pct = fabs(unfold_Vn8Vn4VSChi2Cut[icent][i] - unfold_Vn8Vn4VSChi2Cut[icent][0]) / fabs(unfold_Vn8Vn4VSChi2Cut[icent][0]);
      double vn8vn6Pct = fabs(unfold_Vn8Vn6VSChi2Cut[icent][i] - unfold_Vn8Vn6VSChi2Cut[icent][0]) / fabs(unfold_Vn8Vn6VSChi2Cut[icent][0]);
    ...
    relErrGamma1Exp->SetBinContent(icent+1, reG1Exp);
