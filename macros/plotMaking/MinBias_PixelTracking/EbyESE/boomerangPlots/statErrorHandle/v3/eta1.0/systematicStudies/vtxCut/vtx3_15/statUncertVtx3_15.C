...
void statUncertVtx3_15(int n = 2){
  ...
  //-- Set Up Output files
  fOut = new TFile( Form("StatUncertVtx3_15_v%i.root", norder_), "recreate");

  fOut->cd();
  hVarianceOfMean_Vn2    = new TH1D("hVarianceOfMean_Vn2_Vtx3_15",    "hVarianceOfMean_Vn2_Vtx3_15",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn2->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn2->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn4    = new TH1D("hVarianceOfMean_Vn4_Vtx3_15",    "hVarianceOfMean_Vn4_Vtx3_15",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn4->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn4->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn6    = new TH1D("hVarianceOfMean_Vn6_Vtx3_15",    "hVarianceOfMean_Vn6_Vtx3_15",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn6->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn6->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn8    = new TH1D("hVarianceOfMean_Vn8_Vtx3_15",    "hVarianceOfMean_Vn8_Vtx3_15",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn8->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn8->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Gamma1Exp = new TH1D("hVarianceOfMean_Gamma1Exp_Vtx3_15", "hVarianceOfMean_Gamma1Exp_Vtx3_15", NCENT, centbinsDefault);
  hVarianceOfMean_Gamma1Exp->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Gamma1Exp->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn6Vn4    = new TH1D("hVarianceOfMean_Vn6Vn4_Vtx3_15",    "hVarianceOfMean_Vn6Vn4_Vtx3_15",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn6Vn4->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn6Vn4->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn8Vn4    = new TH1D("hVarianceOfMean_Vn8Vn4_Vtx3_15",    "hVarianceOfMean_Vn8Vn4_Vtx3_15",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn8Vn4->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn8Vn4->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn8Vn6    = new TH1D("hVarianceOfMean_Vn8Vn6_Vtx3_15",    "hVarianceOfMean_Vn8Vn6_Vtx3_15",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn8Vn6->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn8Vn6->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn46_Vn68    = new TH1D("hVarianceOfMean_Vn46_Vn68_Vtx3_15",    "hVarianceOfMean_Vn46_Vn68_Vtx3_15",    NCENT, centbinsDefault);
