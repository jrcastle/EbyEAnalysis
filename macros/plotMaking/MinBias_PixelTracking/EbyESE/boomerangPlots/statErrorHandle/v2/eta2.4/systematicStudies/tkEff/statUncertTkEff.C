...
void statUncertTkEff(){
  ...
  //-- Set Up Output files
  fOut = new TFile( Form("StatUncertTkEff_v%i.root", norder_), "recreate");

  fOut->cd();
  hVarianceOfMean_Vn2    = new TH1D("hVarianceOfMean_Vn2_TkEff",    "hVarianceOfMean_Vn2_TkEff",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn2->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn2->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn4    = new TH1D("hVarianceOfMean_Vn4_TkEff",    "hVarianceOfMean_Vn4_TkEff",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn4->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn4->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn6    = new TH1D("hVarianceOfMean_Vn6_TkEff",    "hVarianceOfMean_Vn6_TkEff",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn6->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn6->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn8    = new TH1D("hVarianceOfMean_Vn8_TkEff",    "hVarianceOfMean_Vn8_TkEff",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn8->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn8->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Gamma1Exp = new TH1D("hVarianceOfMean_Gamma1Exp_TkEff", "hVarianceOfMean_Gamma1Exp_TkEff", NCENT, centbinsDefault);
  hVarianceOfMean_Gamma1Exp->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Gamma1Exp->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn6Vn4    = new TH1D("hVarianceOfMean_Vn6Vn4_TkEff",    "hVarianceOfMean_Vn6Vn4_TkEff",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn6Vn4->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn6Vn4->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn8Vn4    = new TH1D("hVarianceOfMean_Vn8Vn4_TkEff",    "hVarianceOfMean_Vn8Vn4_TkEff",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn8Vn4->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn8Vn4->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn8Vn6    = new TH1D("hVarianceOfMean_Vn8Vn6_TkEff",    "hVarianceOfMean_Vn8Vn6_TkEff",    NCENT, centbinsDefault);
