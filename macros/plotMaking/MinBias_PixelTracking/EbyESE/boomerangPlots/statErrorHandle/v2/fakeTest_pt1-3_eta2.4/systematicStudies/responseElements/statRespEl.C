...
void statRespEl(){
  ...
  //-- Set Up Output files
  fOut = new TFile( Form("StatUncertRespEl_v%i.root", norder_), "recreate");

  fOut->cd();
  hVarianceOfMean_Vn2    = new TH1D("hVarianceOfMean_Vn2_RespEl",    "hVarianceOfMean_Vn2_RespEl",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn2->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn2->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn4    = new TH1D("hVarianceOfMean_Vn4_RespEl",    "hVarianceOfMean_Vn4_RespEl",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn4->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn4->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn6    = new TH1D("hVarianceOfMean_Vn6_RespEl",    "hVarianceOfMean_Vn6_RespEl",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn6->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn6->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn8    = new TH1D("hVarianceOfMean_Vn8_RespEl",    "hVarianceOfMean_Vn8_RespEl",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn8->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn8->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Gamma1Exp = new TH1D("hVarianceOfMean_Gamma1Exp_RespEl", "hVarianceOfMean_Gamma1Exp_RespEl", NCENT, centbinsDefault);
  hVarianceOfMean_Gamma1Exp->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Gamma1Exp->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn6Vn4    = new TH1D("hVarianceOfMean_Vn6Vn4_RespEl",    "hVarianceOfMean_Vn6Vn4_RespEl",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn6Vn4->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn6Vn4->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn8Vn4    = new TH1D("hVarianceOfMean_Vn8Vn4_RespEl",    "hVarianceOfMean_Vn8Vn4_RespEl",    NCENT, centbinsDefault);
  hVarianceOfMean_Vn8Vn4->GetXaxis()->SetTitle("Centrality %");
  hVarianceOfMean_Vn8Vn4->GetXaxis()->SetTitle("#sigma^{2}");

  hVarianceOfMean_Vn8Vn6    = new TH1D("hVarianceOfMean_Vn8Vn6_RespEl",    "hVarianceOfMean_Vn8Vn6_RespEl",    NCENT, centbinsDefault);
  ...
  for(int iS = 0; iS < NSPLIT; iS++){
    ...
    fUnf[iS] = new TFile( Form("../../UnfoldResults/dataResp/data%i_dosys_Split%i.root", norder_, iS) );
