...
void sysTkQuality(){
  ...
  //-- Stat Errors
  fStatLoose = new TFile( Form("../../../../statErrorHandle/v%i/eta2.4/systematicStudies/tkQuality/loose/StatUncertTkQualityLoose_v%i.root", norder_, norder_) );
  ...
  fStatTight = new TFile( Form("../../../../statErrorHandle/v%i/eta2.4/systematicStudies/tkQuality/tight/StatUncertTkQualityTight_v%i.root", norder_, norder_) );
  ...
  fStatNominal = new TFile( Form("../../../../statErrorHandle/v%i/eta2.4/StatisticalUncertainties_v%i.root", norder_, norder_) );
  ...
  for(int icent = 0; icent < NCENT; icent++){
    ...
    double pctVn2_L       = fabs(vn2Loose[icent] - vn2Nominal[icent]) / fabs(vn2Nominal[icent]);
    double pctVn4_L       = fabs(vn4Loose[icent] - vn4Nominal[icent]) / fabs(vn4Nominal[icent]);
    double pctVn6_L       = fabs(vn6Loose[icent] - vn6Nominal[icent]) / fabs(vn6Nominal[icent]);
    double pctVn8_L       = fabs(vn8Loose[icent] - vn8Nominal[icent]) / fabs(vn8Nominal[icent]);
    double pctGamma1Exp_L = fabs(gamma1expLoose[icent] - gamma1expNominal[icent]) / fabs(gamma1expNominal[icent]);
    double pctVn6Vn4_L    = fabs(vn6vn4Loose[icent] - vn6vn4Nominal[icent]) / fabs(vn6vn4Nominal[icent]);
    double pctVn8Vn4_L    = fabs(vn8vn4Loose[icent] - vn8vn4Nominal[icent]) / fabs(vn8vn4Nominal[icent]);
    double pctVn8Vn6_L    = fabs(vn8vn6Loose[icent] - vn8vn6Nominal[icent]) / fabs(vn8vn6Nominal[icent]);

    if( compatibleWithOne(vn2Loose_RatiotoNominal[icent], vn2Loose_RatiotoNominal_staterr[icent]) )             pctVn2_L = 0;
    if( compatibleWithOne(vn4Loose_RatiotoNominal[icent], vn4Loose_RatiotoNominal_staterr[icent]) )             pctVn4_L = 0;
    if( compatibleWithOne(vn6Loose_RatiotoNominal[icent], vn6Loose_RatiotoNominal_staterr[icent]) )             pctVn6_L = 0;
    if( compatibleWithOne(vn8Loose_RatiotoNominal[icent], vn8Loose_RatiotoNominal_staterr[icent]) )             pctVn8_L = 0;
    if( compatibleWithOne(gamma1expLoose_RatiotoNominal[icent], gamma1expLoose_RatiotoNominal_staterr[icent]) ) pctGamma1Exp_L = 0;
    if( compatibleWithOne(vn6vn4Loose_RatiotoNominal[icent], vn6vn4Loose_RatiotoNominal_staterr[icent]) )       pctVn6Vn4_L = 0;
    if( compatibleWithOne(vn8vn4Loose_RatiotoNominal[icent], vn8vn4Loose_RatiotoNominal_staterr[icent]) )       pctVn8Vn4_L = 0;
    if( compatibleWithOne(vn8vn6Loose_RatiotoNominal[icent], vn8vn6Loose_RatiotoNominal_staterr[icent]) )       pctVn8Vn6_L = 0;

    double pctVn2_T       = fabs(vn2Tight[icent] - vn2Nominal[icent]) / fabs(vn2Nominal[icent]);
    double pctVn4_T       = fabs(vn4Tight[icent] - vn4Nominal[icent]) / fabs(vn4Nominal[icent]);
    double pctVn6_T       = fabs(vn6Tight[icent] - vn6Nominal[icent]) / fabs(vn6Nominal[icent]);
    double pctVn8_T       = fabs(vn8Tight[icent] - vn8Nominal[icent]) / fabs(vn8Nominal[icent]);
    double pctGamma1Exp_T = fabs(gamma1expTight[icent] - gamma1expNominal[icent]) / fabs(gamma1expNominal[icent]);
    double pctVn6Vn4_T    = fabs(vn6vn4Tight[icent] - vn6vn4Nominal[icent]) / fabs(vn6vn4Nominal[icent]);
    double pctVn8Vn4_T    = fabs(vn8vn4Tight[icent] - vn8vn4Nominal[icent]) / fabs(vn8vn4Nominal[icent]);
    double pctVn8Vn6_T    = fabs(vn8vn6Tight[icent] - vn8vn6Nominal[icent]) / fabs(vn8vn6Nominal[icent]);

    if( compatibleWithOne(vn2Tight_RatiotoNominal[icent], vn2Tight_RatiotoNominal_staterr[icent]) )             pctVn2_T = 0;
    if( compatibleWithOne(vn4Tight_RatiotoNominal[icent], vn4Tight_RatiotoNominal_staterr[icent]) )             pctVn4_T = 0;
    if( compatibleWithOne(vn6Tight_RatiotoNominal[icent], vn6Tight_RatiotoNominal_staterr[icent]) )             pctVn6_T = 0;
    if( compatibleWithOne(vn8Tight_RatiotoNominal[icent], vn8Tight_RatiotoNominal_staterr[icent]) )             pctVn8_T = 0;
    if( compatibleWithOne(gamma1expTight_RatiotoNominal[icent], gamma1expTight_RatiotoNominal_staterr[icent]) ) pctGamma1Exp_T = 0;
    if( compatibleWithOne(vn6vn4Tight_RatiotoNominal[icent], vn6vn4Tight_RatiotoNominal_staterr[icent]) )       pctVn6Vn4_T = 0;
    if( compatibleWithOne(vn8vn4Tight_RatiotoNominal[icent], vn8vn4Tight_RatiotoNominal_staterr[icent]) )       pctVn8Vn4_T = 0;
    if( compatibleWithOne(vn8vn6Tight_RatiotoNominal[icent], vn8vn6Tight_RatiotoNominal_staterr[icent]) )       pctVn8Vn6_T = 0;
