...
void sysChi2Cutoff(){
  ...
  fStat = new TFile( Form("../../../../statErrorHandle/v%i/eta2.4/systematicStudies/chi2Cutoff/StatUncertChi2Cutoff_v%i.root", norder_, norder_) );
  ...
  for(int icent = 0; icent < NCENT; icent++){
    ...
    for(int i = 0; i < 4; i++){
      ...
      if( compatibleWithOne(unfoldVn2_RatioToChi21[icent][i], unfoldVn2_RatioToChi21_staterr[icent][i]) ) vn2Pct = 0;
      else vn2Pct = fabs(unfold_Vn2VSChi2Cut[icent][i] - unfold_Vn2VSChi2Cut[icent][0]) / fabs(unfold_Vn2VSChi2Cut[icent][0]);

      if( compatibleWithOne(unfoldVn4_RatioToChi21[icent][i], unfoldVn4_RatioToChi21_staterr[icent][i]) ) vn4Pct = 0;      
      else vn4Pct = fabs(unfold_Vn4VSChi2Cut[icent][i] - unfold_Vn4VSChi2Cut[icent][0]) / fabs(unfold_Vn4VSChi2Cut[icent][0]);

      if( compatibleWithOne(unfoldVn6_RatioToChi21[icent][i], unfoldVn6_RatioToChi21_staterr[icent][i]) ) vn6Pct = 0;
      else vn6Pct = fabs(unfold_Vn6VSChi2Cut[icent][i] - unfold_Vn6VSChi2Cut[icent][0]) / fabs(unfold_Vn6VSChi2Cut[icent][0]);

      if( compatibleWithOne(unfoldVn8_RatioToChi21[icent][i], unfoldVn8_RatioToChi21_staterr[icent][i]) ) vn8Pct = 0;
      else vn8Pct = fabs(unfold_Vn8VSChi2Cut[icent][i] - unfold_Vn8VSChi2Cut[icent][0]) / fabs(unfold_Vn8VSChi2Cut[icent][0]);

      if( compatibleWithOne(unfoldGamma1Exp_RatioToChi21[icent][i], unfoldGamma1Exp_RatioToChi21_staterr[icent][i]) ) g1expPct = 0;
      else g1expPct = fabs(unfold_Gamma1ExpVSChi2Cut[icent][i] - unfold_Gamma1ExpVSChi2Cut[icent][0]) / fabs(unfold_Gamma1ExpVSChi2Cut[icent][0]);

      if( compatibleWithOne(unfoldVn6Vn4_RatioToChi21[icent][i], unfoldVn6Vn4_RatioToChi21_staterr[icent][i]) ) vn6vn4Pct = 0;
      else vn6vn4Pct = fabs(unfold_Vn6Vn4VSChi2Cut[icent][i] - unfold_Vn6Vn4VSChi2Cut[icent][0]) / fabs(unfold_Vn6Vn4VSChi2Cut[icent][0]);

      if( compatibleWithOne(unfoldVn8Vn4_RatioToChi21[icent][i], unfoldVn8Vn4_RatioToChi21_staterr[icent][i]) ) vn8vn4Pct = 0;
      else vn8vn4Pct = fabs(unfold_Vn8Vn4VSChi2Cut[icent][i] - unfold_Vn8Vn4VSChi2Cut[icent][0]) / fabs(unfold_Vn8Vn4VSChi2Cut[icent][0]);

      if( compatibleWithOne(unfoldVn8Vn6_RatioToChi21[icent][i], unfoldVn8Vn6_RatioToChi21_staterr[icent][i]) ) vn8vn6Pct = 0;
      else vn8vn6Pct = fabs(unfold_Vn8Vn6VSChi2Cut[icent][i] - unfold_Vn8Vn6VSChi2Cut[icent][0]) / fabs(unfold_Vn8Vn6VSChi2Cut[icent][0]);
