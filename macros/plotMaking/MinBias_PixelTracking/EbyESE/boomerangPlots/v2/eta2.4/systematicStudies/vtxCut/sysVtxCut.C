...
void sysVtxCut(){
  ...
  //-- Stat errors
  fStatVtx3 = new TFile( Form("../../../../statErrorHandle/v%i/eta2.4/systematicStudies/vtxCut/vtx_leq_3/StatUncertVtx_leq_3_v%i.root", norder_, norder_) );
  ...
  fStatVtx3_15 = new TFile( Form("../../../../statErrorHandle/v%i/eta2.4/systematicStudies/vtxCut/vtx3_15/StatUncertVtx3_15_v%i.root", norder_, norder_) );
  ...
  fStatVtx15 = new TFile( Form("../../../../statErrorHandle/v%i/eta2.4/StatisticalUncertainties_v%i.root", norder_, norder_) );
  ...
  for(int icent = 0; icent < NCENT; icent++){
    ...
    if( compatibleWithOne(vn2Vtx3_RatiotoVtx15[icent], vn2Vtx3_RatiotoVtx15_staterr[icent]) )             pctVn2_3 = 0;
    if( compatibleWithOne(vn4Vtx3_RatiotoVtx15[icent], vn4Vtx3_RatiotoVtx15_staterr[icent]) )             pctVn4_3 = 0;
    if( compatibleWithOne(vn6Vtx3_RatiotoVtx15[icent], vn6Vtx3_RatiotoVtx15_staterr[icent]) )             pctVn6_3 = 0;
    if( compatibleWithOne(vn8Vtx3_RatiotoVtx15[icent], vn8Vtx3_RatiotoVtx15_staterr[icent]) )             pctVn8_3 = 0;
    if( compatibleWithOne(gamma1expVtx3_RatiotoVtx15[icent], gamma1expVtx3_RatiotoVtx15_staterr[icent]) ) pctGamma1Exp_3 = 0;
    if( compatibleWithOne(vn6vn4Vtx3_RatiotoVtx15[icent], vn6vn4Vtx3_RatiotoVtx15_staterr[icent]) )       pctVn6Vn4_3 = 0;
    if( compatibleWithOne(vn8vn4Vtx3_RatiotoVtx15[icent], vn8vn4Vtx3_RatiotoVtx15_staterr[icent]) )       pctVn8Vn4_3 = 0;
    if( compatibleWithOne(vn8vn6Vtx3_RatiotoVtx15[icent], vn8vn6Vtx3_RatiotoVtx15_staterr[icent]) )       pctVn8Vn6_3 = 0;
    ...
    if( compatibleWithOne(vn2Vtx3_15_RatiotoVtx15[icent], vn2Vtx3_15_RatiotoVtx15_staterr[icent]) )             pctVn2_3_15 = 0;
    if( compatibleWithOne(vn4Vtx3_15_RatiotoVtx15[icent], vn4Vtx3_15_RatiotoVtx15_staterr[icent]) )             pctVn4_3_15 = 0;
    if( compatibleWithOne(vn6Vtx3_15_RatiotoVtx15[icent], vn6Vtx3_15_RatiotoVtx15_staterr[icent]) )             pctVn6_3_15 = 0;
    if( compatibleWithOne(vn8Vtx3_15_RatiotoVtx15[icent], vn8Vtx3_15_RatiotoVtx15_staterr[icent]) )             pctVn8_3_15 = 0;
    if( compatibleWithOne(gamma1expVtx3_15_RatiotoVtx15[icent], gamma1expVtx3_15_RatiotoVtx15_staterr[icent]) ) pctGamma1Exp_3_15 = 0;
    if( compatibleWithOne(vn6vn4Vtx3_15_RatiotoVtx15[icent], vn6vn4Vtx3_15_RatiotoVtx15_staterr[icent]) )       pctVn6Vn4_3_15 = 0;
    if( compatibleWithOne(vn8vn4Vtx3_15_RatiotoVtx15[icent], vn8vn4Vtx3_15_RatiotoVtx15_staterr[icent]) )       pctVn8Vn4_3_15 = 0;
    if( compatibleWithOne(vn8vn6Vtx3_15_RatiotoVtx15[icent], vn8vn6Vtx3_15_RatiotoVtx15_staterr[icent]) )       pctVn8Vn6_3_15 = 0;
