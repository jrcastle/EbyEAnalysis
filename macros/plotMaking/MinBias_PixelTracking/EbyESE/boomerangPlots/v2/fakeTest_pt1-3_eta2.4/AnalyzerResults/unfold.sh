...
cp $EBYESE/boomerangPlots/v$N/fakeTest_pt1-3_eta2.4/AnalyzerResults/DDResp/dataDrivenResponseAndPriors.root DDResp/dataDrivenResponseAndPriors.root
root -l -b<<EOF
...
EOF
cp txt/PbPb_2015/data/data$N.root $EBYESE/boomerangPlots/v$N/fakeTest_pt1-3_eta2.4/UnfoldResults/dataResp/data${N}.root
