...
void SmoothSys(){
  ...
  std::cout << "Vn2      " << "\tVn4      " << "\tVn6      " << "\tVn8      " << "\tVn6Vn4   " << "\tVn8Vn4   "<< "\tVn8Vn6   " << "\tG1E      " << std::endl;
  ...
  for(int icent = 0; icent < NCENT; icent++){
    ...
    std::cout << sysTotVn2 << "\t" << sysTotVn4 << "\t" << sysTotVn6 << "\t" << sysTotVn8  << "\t" << sysTotVn6Vn4 << "\t" << sysTotVn8Vn4 << "\t" << sysTotVn8Vn6 << "\t" << sysTotG1E << std::endl;

    SmoothSysTotVn2    -> SetBinContent(icent, sysTotVn2);
    SmoothSysTotVn4    -> SetBinContent(icent, sysTotVn4);
    SmoothSysTotVn6    -> SetBinContent(icent, sysTotVn6);
    SmoothSysTotVn8    -> SetBinContent(icent, sysTotVn8);
    SmoothSysTotVn6Vn4 -> SetBinContent(icent, sysTotVn6Vn4);
    SmoothSysTotVn8Vn4 -> SetBinContent(icent, sysTotVn8Vn4);
    SmoothSysTotVn8Vn6 -> SetBinContent(icent, sysTotVn8Vn6);
    SmoothSysTotG1E    -> SetBinContent(icent, sysTotG1E);

    if(centBinCenter[icent] < 10. && centBinCenter[icent] > 5.){
      aveSys_00_10_Vn2    += sysRespVn2;
      aveSys_00_10_Vn4    += sysRespVn4;
      aveSys_00_10_Vn6    += sysRespVn6;
      aveSys_00_10_Vn8    += sysRespVn8;
      aveSys_00_10_Vn6Vn4 += sysRespVn6Vn4;
      aveSys_00_10_Vn8Vn4 += sysRespVn8Vn4;
      aveSys_00_10_Vn8Vn6 += sysRespVn8Vn6;
      aveSys_00_10_G1E    += sysRespG1E;
    }
    if(centBinCenter[icent] > 10. && centBinCenter[icent] < 50.){
      aveSys_10_50_Vn2    += sysRespVn2;
      aveSys_10_50_Vn4    += sysRespVn4;
      aveSys_10_50_Vn6    += sysRespVn6;
      aveSys_10_50_Vn8    += sysRespVn8;
      aveSys_10_50_Vn6Vn4 += sysRespVn6Vn4;
      aveSys_10_50_Vn8Vn4 += sysRespVn8Vn4;
      aveSys_10_50_Vn8Vn6 += sysRespVn8Vn6;
      aveSys_10_50_G1E    += sysRespG1E;
    }
    if(centBinCenter[icent] > 50.){
      aveSys_50_60_Vn2    += sysRespVn2;
      aveSys_50_60_Vn4    += sysRespVn4;
      aveSys_50_60_Vn6    += sysRespVn6;
      aveSys_50_60_Vn8    += sysRespVn8;
      aveSys_50_60_Vn6Vn4 += sysRespVn6Vn4;
      aveSys_50_60_Vn8Vn4 += sysRespVn8Vn4;
      aveSys_50_60_Vn8Vn6 += sysRespVn8Vn6;
      aveSys_50_60_G1E    += sysRespG1E;
    }
  ...
  std::cout << "10-50%\t" << Form("%.1f", aveSys_10_50_Vn2)    << "\t" << Form("%.1f", aveSys_10_50_Vn4)    << "\t" << Form("%.1f", aveSys_10_50_Vn6)
            << "\t"       << Form("%.1f", aveSys_10_50_Vn8)    << "\t" << Form("%.1f", aveSys_10_50_G1E)    << "\t" << Form("%.1f", aveSys_10_50_Vn6Vn4)
            << "\t"       << Form("%.1f", aveSys_10_50_Vn8Vn4) << "\t" << Form("%.1f", aveSys_10_50_Vn8Vn6) << std::endl;
