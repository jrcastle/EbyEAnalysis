...
void qCumulantCompare(){
  ...
  //-- Get EbyE physics
  fEbyE = new TFile("PhysicsResults.root");
  ...
  for(int icent = 0; icent < NQCENT; icent++){
    ...
    double vn2EbyE_err    = sqrt( pow(vn2EbyE_StatErr,2) );
    double vn4EbyE_err    = sqrt( pow(vn4EbyE_StatErr,2) );
    double vn6EbyE_err    = sqrt( pow(vn6EbyE_StatErr,2) );
    double vn8EbyE_err    = sqrt( pow(vn8EbyE_StatErr,2) );
    double vn6vn4EbyE_err = sqrt( pow(vn6vn4EbyE_StatErr,2) );
    double vn8vn4EbyE_err = sqrt( pow(vn8vn4EbyE_StatErr,2) );
    double vn8vn6EbyE_err = sqrt( pow(vn8vn6EbyE_StatErr,2) );
    double g1eEbyE_err    = sqrt( pow(g1eEbyE_StatErr,2) );
