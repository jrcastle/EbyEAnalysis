...
void mcTruthCompare(){
  ...
  double quanV24 = 0.00892593257325;
  double quanV26 = 0.00867193468469;
  double quanV28 = 0.0086596124532;

  double quanV24e = 8.85525193796e-05;
  double quanV26e = 0.000121828358952;
  double quanV28e = 0.000142195984115;
  ...
  grEbyE->SetMinimum(0.0);
  grEbyE->SetMaximum(0.012);
  //grTrue->SetMinimum(0.082);
  //grTrue->SetMaximum(0.084);
  grQuan->SetMinimum(0.0);
  grQuan->SetMaximum(0.012);
  ...
  hFinalUnfold[c]->GetXaxis()->SetRange(1, hFinalUnfold[c]->FindBin(0.1));
  ...
  latex.DrawLatex(0.778, 0.89, "#bf{HIJING}");
  ...
  grQuan->Draw("same");
  legQ->Draw("same");
  latex.DrawLatex(0.2, 0.89, "#bf{HIJING}");
