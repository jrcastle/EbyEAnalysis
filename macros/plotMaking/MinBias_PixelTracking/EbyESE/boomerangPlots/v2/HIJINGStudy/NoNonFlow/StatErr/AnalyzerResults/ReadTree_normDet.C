...
void ReadTree_normDet(){
  ...
  TH1D * hVnFull_Wider[NCENT][NSPLIT];
  TH1D * hVnFull_Thinner[NCENT][NSPLIT];
  ...
  fAna = new TFile(fAnaTreeNameHIJINGNoNonFlow);
  ...
  tree->SetBranchAddress("V2True",                  &v2True);
  ...
  for(int iS = 0; iS < NSPLIT; iS++){
    ...
    for(int icent = 0; icent < NCENT; icent++){
      ...
      hVnFull_Wider[icent][iS]      = new TH1D( Form("hVnFull_Wider_c%i", icent), Form("hVnFull_Wider_c%i", icent), NBins, 0., vnMax[norder_] );
      hVnFull_Wider[icent][iS]->GetXaxis()->SetTitle( Form("v_{%i}", norder_) );
      hVnFull_Wider[icent][iS]->GetYaxis()->SetTitle( "Events" );

      hVnFull_Thinner[icent][iS]    = new TH1D( Form("hVnFull_Thinner_c%i", icent), Form("hVnFull_Thinner_c%i", icent), NBins, 0., vnMax[norder_] );
      hVnFull_Thinner[icent][iS]->GetXaxis()->SetTitle( Form("v_{%i}", norder_) );
      hVnFull_Thinner[icent][iS]->GetYaxis()->SetTitle( "Events" );
      ...
      hV2True[icent][iS] = new TH1D( Form("hV2True_c%i", icent), Form("hV2True_c%i", icent), NBins, 0., vnMax[norder_] );
      hV2True[icent][iS]->GetXaxis()->SetTitle( Form("v_{%i}", norder_) );
  ...
  for(int ievent = 0; ievent < N; ievent++) {
    ...
    //-- Truth
    hV2True[icent][iSplit]->Fill( v2True );
    ...
    hVnFull_Wider[icent][iSplit]   -> Fill( (1.+priorVary)*vn_full );
    hVnFull_Thinner[icent][iSplit] -> Fill( (1.-priorVary)*vn_full );
