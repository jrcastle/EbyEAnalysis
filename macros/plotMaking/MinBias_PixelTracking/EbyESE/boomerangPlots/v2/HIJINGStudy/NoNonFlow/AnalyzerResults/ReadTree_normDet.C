...
void ReadTree_normDet(){
  ...
  TH2D * hVn2D0v1[NCENT];
  TH1D * hVnFull[NCENT];
  TH1D * hVnFull_Wider[NCENT];
  TH1D * hVnFull_Thinner[NCENT];
  TH1D * hVnSub0[NCENT];
  TH1D * hVnSub1[NCENT];
  TH1I * Mult[NCENT];
  ...
  //fAna = new TFile( "EbyETree_HIJINGFLow.root" );
  ...
  for(int icent = 0; icent < NCENT; icent++){
    ...
    hVnFull_Wider[icent]      = new TH1D( Form("hVnFull_Wider_c%i", icent), Form("hVnFull_Wider_c%i", icent), NBins, 0., vnMax[norder_] );
    hVnFull_Wider[icent]->GetXaxis()->SetTitle( Form("v_{%i}", norder_) );
    hVnFull_Wider[icent]->GetYaxis()->SetTitle( "Events" );

    hVnFull_Thinner[icent]    = new TH1D( Form("hVnFull_Thinner_c%i", icent), Form("hVnFull_Thinner_c%i", icent), NBins, 0., vnMax[norder_] );
    hVnFull_Thinner[icent]->GetXaxis()->SetTitle( Form("v_{%i}", norder_) );
    hVnFull_Thinner[icent]->GetYaxis()->SetTitle( "Events" );
    ...
    hV2True[icent] = new TH1D( Form("hV2True_c%i", icent), Form("hV2True_c%i", icent), NBins, 0., vnMax[norder_] );
    hV2True[icent]->GetXaxis()->SetTitle( Form("v_{%i}", norder_) );
  ...
  for(int ievent = 0; ievent < N; ievent++) {
    ...
    hVnFull_Wider[icent]   -> Fill( (1.+priorVary)*vn_full );
    hVnFull_Thinner[icent] -> Fill( (1.-priorVary)*vn_full );
