...
void mcTruthCompare(){
  ...
  double quanV24 = 0.0832056;
  double quanV26 = 0.0828900;
  double quanV28 = 0.0828492;

  double quanV24e = 0.000104530;
  double quanV26e = 7.98564e-05;
  double quanV28e = 6.94302e-05;
  ...
  //-- Draw Quan Compare
  TLegend * legQ = new TLegend(0.70, 0.78, 0.95, 0.93);
  legInit(legQ);
  ...
  grQuan->Draw("same");
  legQ->Draw("same");
  latex.DrawLatex(0.2, 0.89, "#bf{HIJING + Flow Afterburner}");
