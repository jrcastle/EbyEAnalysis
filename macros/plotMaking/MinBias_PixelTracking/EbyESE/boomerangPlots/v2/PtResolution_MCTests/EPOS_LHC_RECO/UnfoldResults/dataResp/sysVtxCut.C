...
void sysVtxCut(){
  ...
  fUnfVtx15    = new TFile( Form("data%i.root", norder_) );

  fAnaVtx3_15 = new TFile( "../../AnalyzerResults_vtx3_15/CastleEbyE.root" );
  fUnfVtx3_15 = new TFile( Form("data%ivtx3_15.root", norder_) );

  fAnaVtx3   = new TFile( "../../AnalyzerResults_vtx_leq_3/CastleEbyE.root"  );
  fUnfVtx3   = new TFile( Form("data%ivtx3.root", norder_) );
  ...
  */
  for(int icent = 0; icent < NCENT; icent++){
	...
	vn2Vtx3_staterr[icent]       = 0;//sqrt( hVarianceOfMean_Vn2_Vtx3->GetBinContent(icent+1) );
        vn4Vtx3_staterr[icent]       = 0;//sqrt( hVarianceOfMean_Vn4_Vtx3->GetBinContent(icent+1) );
        vn6Vtx3_staterr[icent]       = 0;//sqrt( hVarianceOfMean_Vn6_Vtx3->GetBinContent(icent+1) );
        vn8Vtx3_staterr[icent]       = 0;//sqrt( hVarianceOfMean_Vn8_Vtx3->GetBinContent(icent+1) );
        gamma1expVtx3_staterr[icent] = 0;//sqrt( hVarianceOfMean_Gamma1Exp_Vtx3->GetBinContent(icent+1) );
        vn6vn4Vtx3_staterr[icent]    = 0;//sqrt( hVarianceOfMean_Vn6Vn4_Vtx3->GetBinContent(icent+1) );
        vn8vn4Vtx3_staterr[icent]    = 0;//sqrt( hVarianceOfMean_Vn8Vn4_Vtx3->GetBinContent(icent+1) );
        vn8vn6Vtx3_staterr[icent]    = 0;//sqrt( hVarianceOfMean_Vn8Vn6_Vtx3->GetBinContent(icent+1) );
	vn46_vn68Vtx3_staterr[icent] = 0;//sqrt( hVarianceOfMean_Vn46_Vn68_Vtx3->GetBinContent(icent+1) );
	...
	if(vn4Vtx3_15[icent] == 0 || vn6Vtx3_15[icent] == 0 || vn8Vtx3_15[icent] == 0) vn46_vn68Vtx3_15[icent] = 0;
        ...
        vn2Vtx3_15_staterr[icent]       = 0;//sqrt( hVarianceOfMean_Vn2_Vtx3_15->GetBinContent(icent+1) );
        vn4Vtx3_15_staterr[icent]       = 0;//sqrt( hVarianceOfMean_Vn4_Vtx3_15->GetBinContent(icent+1) );
        vn6Vtx3_15_staterr[icent]       = 0;//sqrt( hVarianceOfMean_Vn6_Vtx3_15->GetBinContent(icent+1) );
        vn8Vtx3_15_staterr[icent]       = 0;//sqrt( hVarianceOfMean_Vn8_Vtx3_15->GetBinContent(icent+1) );
        gamma1expVtx3_15_staterr[icent] = 0;//sqrt( hVarianceOfMean_Gamma1Exp_Vtx3_15->GetBinContent(icent+1) );
        vn6vn4Vtx3_15_staterr[icent]    = 0;//sqrt( hVarianceOfMean_Vn6Vn4_Vtx3_15->GetBinContent(icent+1) );
        vn8vn4Vtx3_15_staterr[icent]    = 0;//sqrt( hVarianceOfMean_Vn8Vn4_Vtx3_15->GetBinContent(icent+1) );
        vn8vn6Vtx3_15_staterr[icent]    = 0;//sqrt( hVarianceOfMean_Vn8Vn6_Vtx3_15->GetBinContent(icent+1) );
	vn46_vn68Vtx3_15_staterr[icent] = 0;//sqrt( hVarianceOfMean_Vn46_Vn68_Vtx3_15->GetBinContent(icent+1) );
	...
	if(vn4Vtx15[icent] == 0 || vn6Vtx15[icent] == 0 || vn8Vtx15[icent] == 0) vn46_vn68Vtx15[icent] = 0;
        ...
        vn2Vtx15_staterr[icent]       = 0;//sqrt( hVarianceOfMean_Vn2_Vtx15->GetBinContent(icent+1) );
        vn4Vtx15_staterr[icent]       = 0;//sqrt( hVarianceOfMean_Vn4_Vtx15->GetBinContent(icent+1) );
        vn6Vtx15_staterr[icent]       = 0;//sqrt( hVarianceOfMean_Vn6_Vtx15->GetBinContent(icent+1) );
        vn8Vtx15_staterr[icent]       = 0;//sqrt( hVarianceOfMean_Vn8_Vtx15->GetBinContent(icent+1) );
        gamma1expVtx15_staterr[icent] = 0;//sqrt( hVarianceOfMean_Gamma1Exp_Vtx15->GetBinContent(icent+1) );
        vn6vn4Vtx15_staterr[icent]    = 0;//sqrt( hVarianceOfMean_Vn6Vn4_Vtx15->GetBinContent(icent+1) );
        vn8vn4Vtx15_staterr[icent]    = 0;//sqrt( hVarianceOfMean_Vn8Vn4_Vtx15->GetBinContent(icent+1) );
        vn8vn6Vtx15_staterr[icent]    = 0;//sqrt( hVarianceOfMean_Vn8Vn6_Vtx15->GetBinContent(icent+1) );
        vn46_vn68Vtx15_staterr[icent] = 0;//sqrt( hVarianceOfMean_Vn46_Vn68_Vtx15->GetBinContent(icent+1) );
  ...
  int icent = 0;
  std::cout << Form("c%i\t Vz < 15 iter = %i \t Vz < 3 iter = %i \t 3<Vz<15 iter = %i", icent, iter[iterCutoffVtx15[icent]], iter[iterCutoffVtx3[icent]], iter[iterCutoffVtx3_15[icent]]) << std::endl;
