...
void svdUnfoldResults(){
  ...
  */
  ...
  for(int icent = 0; icent < NCENT; icent++){
    ...
    hObs[icent]->SetMaximum(finalUnf[icent][kreg-1]->GetMaximum()*2.);
    hObs[icent]->Draw();
    ...
    hCorrMatrix[icent] = new TH2D( Form("hCorrMatrix_c%i", icent), Form("hCorrMatrix_c%i", icent), NBinsV2[icent]/2, 0., v2Max[icent], NBinsV2[icent]/2, 0., v2Max[icent] );
    ...
    TMatrixD S(NBinsV2[icent]/2, NBinsV2[icent]/2);
    for(int i = 0; i<NBinsV2[icent]/2; i++){
      S(i,i) = sqrt( MCov(i,i) );
    }
    TDecompSVD svd(S);
